...
Скинуть ссылку на репозиторий на проверку личным сообщение

'''
#    Выполненное задание находится в репорепозитории с названием lesson2 по ссылке:
#    https://github.com/DziyanaLysak/lesson2.git